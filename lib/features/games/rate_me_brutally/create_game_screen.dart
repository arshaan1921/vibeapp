...
class CreateRateGameScreen extends StatefulWidget {
  const CreateRateGameScreen({super.key});

  @override
  State<CreateRateGameScreen> createState() => _CreateRateGameScreenState();
}

class _CreateRateGameScreenState extends State<CreateRateGameScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('New "Rate Me" Game')),
      body: Column(
        children: [
          Padding(
